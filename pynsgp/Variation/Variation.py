...
def SubtreeMutation( individual, functions, terminals, max_height=4, method='grow', min_depth=2 ):

	mutation_branch = GenerateRandomTree( functions, terminals, max_height, curr_height=0, method=method, min_depth=min_depth )
...
def SubtreeCrossover( individual, donor ):
	...
	idx_node1 = randint(len(nodes1))
	to_swap1 = nodes1[ idx_node1 ]
	...
	idx_replacement = p1.DetachChild(to_swap1)
	p1.InsertChildAtPosition(idx_replacement, to_swap2)
